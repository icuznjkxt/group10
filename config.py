...
STEERING_LEFT_PWM = 487         #pwm value for full left steering
STEERING_RIGHT_PWM = 290        #pwm value for full right steering

#THROTTLE
THROTTLE_CHANNEL = 0            #channel on the 9685 pwm board 0-15
THROTTLE_FORWARD_PWM = 477      #pwm value for max forward throttle
...
RANGE_TRIG_GPIO = 18#触发引脚
RANGE_ECHO_GPIO = 23#回声引脚
RANGE_GPIOS = [
    RANGE_TRIG_GPIO,
    RANGE_ECHO_GPIO
]
